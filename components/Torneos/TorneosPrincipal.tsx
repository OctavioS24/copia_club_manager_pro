    ...
    <div className="p-6 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-6 py-3 bg-pink-600 hover:bg-pink-700 text-white rounded-xl font-semibold transition-all shadow-lg shadow-pink-900/20"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <div className="relative group">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-slate-800/50 border border-slate-700 rounded-2xl text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:border-pink-500 transition-all"
            />
          </div>
            ...
            {isLoading ? (
              ...
              filteredTournaments.map((tournament) => (
                <motion.div
                  ...
                  className="bg-slate-800/40 border border-slate-700/50 rounded-2xl p-5 hover:border-pink-500/30 transition-all group"
                >
                  <div className="flex flex-col md:flex-row justify-between gap-4">
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-slate-400">
                        ...
                        <span className="text-pink-500/80 font-medium uppercase tracking-tight">
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-pink-600/20 to-purple-600/20 border border-pink-500/20 rounded-3xl p-6">
